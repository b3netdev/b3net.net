                ...
                <div className="container">
                    <div className="hero-content animate-slide-up">
                        ...
                        <div className="hero-btn mt-2 mt-md-3">
                            <a href="#contact" className="btn button-gradient-1">Get Started Today <i
                                    className="fa-solid fa-arrow-right"></i></a>
                            <a href="#works" className="btn button-1">View Our Work <i className="fa-solid fa-arrow-right"></i></a>
                        </div>

                        <section className="stats-section mt-2 mt-md-4">
                            <div className="container text-center position-relative">

                                <p className="trusted-title mb-2">Trusted by <strong>B3NET</strong> Technologies</p>

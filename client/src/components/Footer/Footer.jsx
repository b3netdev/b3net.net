      ...
      <footer className="footer-section">
        <div className="container">
          <div className="row align-items-center text-white text-center text-md-start">
            <div className="col-12 col-sm-6 col-xl-3 mb-3 mb-sm-0 mb-lg-auto order-2 order-xl-0 d-flex align-items-center no-margin">
            ...
            <div className="col-12 col-sm-6 col-xl-2 d-flex justify-content-center justify-content-md-end order-2 order-xl-0">
              <div className="social-icons">
                ...
                <a href="https://www.linkedin.com/company/b3-net-technologies-pvt-ltd-/" target="_blank" className="icon linkedin mt-2 mt-m-0">
